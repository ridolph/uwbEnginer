...
void AES::Cipher(unsigned char* input, unsigned char *out)
{
...
void AES::InvCipher(unsigned char* input, unsigned char* out)
{
	unsigned char state[4][4];
	int i,r,c;
...
int test_aes()
{
    ...
    unsigned char buf[17] = "time:5040";
    unsigned char out[17] = {0};
    AES aes(key);
    aes.Cipher(buf, out);
    printf("out:%s\n",out);
    memset(buf, 0, sizeof(buf));
    aes.InvCipher(out, buf);
    printf("buf:%s\n",buf);
}
